...
//TRAEMOS TODOS LOS PERSONAJES. Loss paginados, filtros y ordenamiento los hacemos en el Front
...
router.get("/characters", async (req, res) => {
  ...
  console.log(`Algo salio mal al buscar personajes${err}`)
}
})
...
router.get("/occupations", async (req, res) => {
  ...
  console.log(`Algo salio mal al guardar personajes${err}`)
}})
...
router.post("/character", async (req, res) => {
  ...
  characterCreated.addOccupation(occupationDb) //agrego las ocupaciones al personaje creado (las ocupaciones se cargaran como array)
...
catch(err){console.log(`Algo salio mal al buscar por "id" ${err}`)}
})
